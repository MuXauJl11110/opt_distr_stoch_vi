...
import schema
import yaml
from decentralized.definitions import ROOT_DIR
...
class NetworkConfigManager(object):
    ...
    def __init__(
        self,
        config_path: Optional[str] = "network/configs/default_config.yaml",
        general_config_path: Optional[str] = "network/configs/general_config.yaml",
    ):
        """
