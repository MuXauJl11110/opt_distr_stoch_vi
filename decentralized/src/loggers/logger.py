...
class LoggerConfigManager(object):
    ...
    def __init__(
        ...
        general_config_path: Optional[
            str
        ] = "./configs/centralized/general_config_logger.yaml",
        default_config_path: Optional[
            str
        ] = "./configs/centralized/default_config_logger.yaml",
        optional_config_path: Optional[
            str
        ] = "./configs/centralized/optional_config_logger.yaml",
    ...
    def add_distance_function(
        self, distance_function_name: str, distance_function_config: dict
    ):
...
class LoggerDecentralized(Logger):
    """
    Instrument for saving method history during its iterations for src methods.
    ...
    def __init__(
        ...
        general_config_path: Optional[
            str
        ] = "./configs/decentralized/general_config_logger.yaml",
        default_config_path: Optional[
            str
        ] = "./configs/decentralized/default_config_logger.yaml",
        optional_config_path: Optional[
            str
        ] = "./configs/decentralized/optional_config_logger.yaml",
        config: Optional[dict] = None,
        z_true: Optional[np.ndarray] = None,
        g_true: Optional[np.ndarray] = None,
    ):
