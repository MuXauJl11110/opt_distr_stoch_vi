...
class DecentralizedVIADOM(BaseSaddleMethod):
    ...
    def __init__(
        self,
        oracles: List[BaseSmoothSaddleOracle],
        x_0: ArrayPair,  # List[ArrayPair],
        y_0: ArrayPair,  # List[ArrayPair],
        z_0: ArrayPair,  # List[ArrayPair],
        eta_x: float,
        eta_y: float,
        eta_z: float,
        theta: float,
        ...
        self.y_list_f = init_from_pair(y_0)

        self.x_list = init_from_pair(x_0)
        self.x_list_old = init_from_pair(x_0)
        self.x_list_f = init_from_pair(x_0)
